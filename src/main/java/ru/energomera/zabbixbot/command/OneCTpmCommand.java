...
//
//public class OneCTpmCommand implements Command, Chart{
//    private final SendMessageService sendMessageService;
//    private final ZabbixRestService zabbixRestService = new ZabbixRestService(new RestTemplateBuilder());
//
//    private final String chartName = "1C TPM: ICMP ping";
//    private final String asixXName = "время";
//    private final String asixYName = "ответ";
//    private final String seriesName = "ICMP ping";
//
//
//    public OneCTpmCommand(SendMessageService sendMessageService) {
...
//
//        RequestToZabbixHistory proxyIcmpRequest = new RequestToZabbixHistory(33851, 10);
